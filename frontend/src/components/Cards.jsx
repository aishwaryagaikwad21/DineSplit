...
const Cards = () => {
  return (
    <>
        <div className='grid grid-cols-1 gap-8 my-5 sm:grid-cols-2 md:grid-cols-4  md:gap-2'>
            <div className='flex flex-col items-center'>
                ...
                <p className='text-zinc-700'>Friends, family, or coworkers.</p>
            </div>
            ...
            <div className='flex flex-col items-center'>
                ...
                <p className='text-zinc-700'>Add items, split, and settle in seconds.</p>
            </div>
            ...
            <div className='flex flex-col items-center'>
                ...
                <p className='text-zinc-700'>No more awkward money conversations.</p>
            </div>
            ...
            <div className='flex flex-col items-center'>
                ...
                <p className='text-zinc-700'>Less math, more memories.</p>
            </div>
        </div>
    </>
  )
